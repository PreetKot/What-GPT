...
<p align="center">
  <img src="public/w-logo.svg" alt="whattt! GPT Logo" width="120" />
</p>

# whattt! GPT

<p align="center">
  <b>The open-source, local-first AI chatbot platform with beautiful UX, tool integrations, and full control.</b><br/>
  <i>Powered by Next.js, Vercel AI SDK, and Model Context Protocol (MCP).</i>
</p>
...
- 🧠 Chat with multiple LLMs (OpenAI, Google, Anthropic, Ollama, and more)
- 🛠️ Integrate and call external tools via MCP (Model Context Protocol)
- 🔗 Visual workflow builder for custom tool chains
- 🎙️ Voice assistant mode (realtime streaming)
- 🌐 Web search and content extraction
- 🗂️ Project-based chat, system prompts, and tool presets
- 🔒 Local-first, privacy-respecting, and self-hostable
- 🖼️ Modern, responsive UI with dark/light themes
- 🧩 Easy plugin architecture for new tools and providers
- 🏷️ Multi-language support and easy translation
